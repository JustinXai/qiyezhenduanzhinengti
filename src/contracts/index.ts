...
export const ReputationAndPublicOpinionSnapshotV1 = z.object({
  ...
  reputationNeutralBase: z.number().min(0).max(100).optional(),
  positiveReputationBonus: z.number().min(0).max(20).optional(),
  preNegativeReputationScore: z.number().min(0).max(100).optional(),
